...
class DrawerFinderDriver extends StatefulWidget {
  const DrawerFinderDriver({super.key});

  @override
  State<DrawerFinderDriver> createState() => _DrawerFinderDriverState();
}

class _DrawerFinderDriverState extends State<DrawerFinderDriver> {
  @override
        ...
        children: [
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.pushReplacementNamed(context, AppRoutes.home_driver);
              },
              child: Container(
                height: 50,
                width: double.infinity,
