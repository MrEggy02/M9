...
//                       ),
//                       child: account.image != null && account.image!.isNotEmpty
//                           ? ClipRRect(
//                               borderRadius: BorderRadius.circular(12),
//                               child: Image.network(
//                                 account.image!,
...
//                onPressed: () async {
//   context.read<AuthCubit>().clearBankForm();
//   await Navigator.push(
//     context,
//     MaterialPageRoute(
//       builder: (context) => BankAccountPage(editBankAccount: account),
//     ),
//   );
...
//                       const SnackBar(
//                         content: Text('ລົບບັນຊີທະນາຄານສຳເລັດແລ້ວ'),
...
//           const SizedBox(height: 32),
//           ElevatedButton(
//             onPressed: () => context.read<AuthCubit>().getBankAccounts(),
//             style: ElevatedButton.styleFrom(
//               backgroundColor: const Color(0xFFFECE0C),
//               foregroundColor: Colors.black,
//               shape: RoundedRectangleBorder(
...
//     if (state.authStatus == AuthStatus.failure && state.hasError) {
//       ScaffoldMessenger.of(context).showSnackBar(
...
//                   children: [
//                     Text(
//                       'ທັງໝົດ ${state.bankAccounts.length} ບັນຊີ',
//                       style: TextStyle(
//                         fontSize: 16,
//                         color: Colors.black.withOpacity(0.6),
//                         fontWeight: FontWeight.w500,
...
//                   onRefresh: () => context.read<AuthCubit>().getBankAccounts(),
//                   color: const Color(0xFFFECE0C),
//                   child: ListView.builder(
//                     padding: const EdgeInsets.only(top: 8, bottom: 100),
//                     itemCount: state.bankAccounts.length,
//                     itemBuilder: (context, index) {
//                       return _buildBankAccountCard(state.bankAccounts[index]);
//                     },
//                   ),
//                 ),
//               ),
